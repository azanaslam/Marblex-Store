    ...
    <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          <Typography variant="overline" sx={{ letterSpacing: 4, fontWeight: 800, color: '#f43f5e', mb: 2, display: 'block' }}>
            SINCE 2010
          </Typography>
          <Typography variant="h1" sx={{ fontWeight: 900, fontSize: { xs: '2.5rem', md: '4.5rem' }, mb: 4, lineHeight: 1.1 }}>
          ...
          <Typography variant="h6" sx={{ color: '#94a3b8', fontWeight: 500, lineHeight: 1.8, maxWidth: 800, mx: 'auto', fontSize: { xs: '1rem', md: '1.25rem' } }}>
      ...
      <Container maxWidth="lg" sx={{ mt: -8, mb: 12 }}>
        <Grid container spacing={4}>
          <Grid item xs={12} md={7}>
            <Paper elevation={0} sx={{ p: { xs: 4, md: 8 }, borderRadius: 6, border: '1px solid #f1f5f9', height: '100%', shadow: '0 20px 50px -12px rgba(0,0,0,0.05)' }}>
              <Typography variant="h3" sx={{ fontWeight: 900, mb: 3, color: '#1e293b' }}>The Marblex Legacy</Typography>
              <div className="w-20 h-1.5 bg-rose-600 rounded-full mb-8"></div>
              <Typography variant="body1" sx={{ color: '#475569', lineHeight: 2, mb: 4, fontSize: '1.1rem' }}>
              ...
              <Typography variant="body1" sx={{ color: '#475569', lineHeight: 2, mb: 6, fontSize: '1.1rem' }}>
          ...
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative', height: '100%', borderRadius: 6, overflow: 'hidden', minHeight: 400, border: '8px solid white', shadow: '0 25px 50px -12px rgba(0,0,0,0.25)' }}>
              <img 
        ...
        <Box sx={{ py: { xs: 10, md: 15 } }}>
          <Box sx={{ textAlign: 'center', mb: 10 }}>
            <Typography variant="overline" sx={{ color: '#f43f5e', fontWeight: 900, letterSpacing: 4, display: 'block', mb: 2 }}>
              OUR VALUES
            </Typography>
            <Typography variant="h3" sx={{ fontWeight: 900, color: '#1e293b', mb: 3 }}>Our Core Principles</Typography>
            <Typography variant="body1" sx={{ color: '#64748b', maxWidth: 600, mx: 'auto', fontWeight: 500 }}>
          ...
          <Grid container spacing={2} justifyContent="center">
            {values.map((v, i) => (
              <Grid item xs={12} sm={4} key={i}>
                <div className="group bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-200 shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 hover:border-rose-500/30 transition-all duration-500 h-full flex flex-col items-center text-center max-w-[400px] mx-auto">
      ...
      {/* Contact Section */}
      <Box id="contact-form" sx={{ py: { xs: 10, md: 20 }, bgcolor: '#0f172a', color: 'white', position: 'relative', overflow: 'hidden' }}>
          ...
          <Grid container spacing={8} alignItems="center">
            <Grid item xs={12} md={5}>
              <Box>
                ...
                <Typography variant="h2" sx={{ fontWeight: 900, mb: 4, fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.1 }}>
                  Let's Build <br /> Something <span className="text-rose-500">Great</span>
                </Typography>
                <Typography variant="body1" sx={{ color: '#94a3b8', mb: 8, fontSize: '1.25rem', lineHeight: 1.8, maxWidth: 400 }}>
                  Our specialists are ready to help you with your construction or style needs.
                </Typography>
                
                <div className="space-y-8">
                  <div className="flex items-center gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-rose-500 group-hover:bg-rose-500 group-hover:text-white transition-all duration-300">
                      <BusinessIcon />
                    </div>
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Corporate Office</p>
                      <p className="text-lg font-bold">40-Ferozpur Road, Lahore</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-blue-500 group-hover:bg-blue-500 group-hover:text-white transition-all duration-300">
                      <SendIcon />
                    </div>
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Direct Email</p>
                      <p className="text-lg font-bold">Sales@themarflexgroup.com</p>
                    </div>
                  </div>
                </div>
              </Box>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[3rem] shadow-2xl">
                {success ? (
                  <div className="text-center py-10">
                    ...
                    <p className="text-slate-400 font-medium mb-8">Thank you for reaching out. We will get back to you shortly.</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          required
                          className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-rose-500/50 transition-all text-white font-medium placeholder:text-slate-600"
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        required
                        rows={5}
                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-rose-500/50 transition-all text-white font-medium placeholder:text-slate-600 resize-none"
                    ...
                    <button 
                      type="submit" 
                      disabled={loading}
                      className="w-full bg-gradient-to-r from-rose-600 to-rose-500 py-5 rounded-2xl text-white font-black text-lg shadow-xl shadow-rose-600/20 hover:shadow-rose-600/40 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                    >
                      {loading ? "Processing..." : (
